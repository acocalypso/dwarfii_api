...
export function messageAstroStartWideCaptureLiveStacking() {
    let module_id = Dwarfii_Api.ModuleId.MODULE_ASTRO;
    let interface_id = Dwarfii_Api.DwarfCMD.CMD_ASTRO_START_WIDE_CAPTURE_LIVE_STACKING;
    let type_id = Dwarfii_Api.MessageTypeId.TYPE_REQUEST;
    // Obtain classname depending of the command
    // Obtain a message class
    const cmdClass = cmdMapping[interface_id];
...
export function messageAstroStopWideCaptureLiveStacking() {
    let module_id = Dwarfii_Api.ModuleId.MODULE_ASTRO;
    let interface_id = Dwarfii_Api.DwarfCMD.CMD_ASTRO_STOP_WIDE_CAPTURE_LIVE_STACKING;
    let type_id = Dwarfii_Api.MessageTypeId.TYPE_REQUEST;
    // Obtain classname depending of the command
    // Obtain a message class
    const cmdClass = cmdMapping[interface_id];
 ...
 * @returns {Uint8Array}
 */
export function messageAstroCaptureDarkFrameWithParam(exp_index, gain_index, bin_index, cap_size) {
    let module_id = Dwarfii_Api.ModuleId.MODULE_ASTRO;
    let interface_id = Dwarfii_Api.DwarfCMD.CMD_ASTRO_START_CAPTURE_RAW_DARK_WITH_PARAM;
    let type_id = Dwarfii_Api.MessageTypeId.TYPE_REQUEST;
    // Obtain classname depending of the command
    // Obtain a message class
    const cmdClass = cmdMapping[interface_id];
...
export function messageAstroStopCaptureDarkFrameWithParam() {
    let module_id = Dwarfii_Api.ModuleId.MODULE_ASTRO;
    let interface_id = Dwarfii_Api.DwarfCMD.CMD_ASTRO_STOP_CAPTURE_RAW_DARK_WITH_PARAM;
    let type_id = Dwarfii_Api.MessageTypeId.TYPE_REQUEST;
    // Obtain classname depending of the command
    // Obtain a message class
    const cmdClass = cmdMapping[interface_id];
 ...
 * @returns {Uint8Array}
 */
export function messageAstroCaptureWideDarkFrameWithParam(exp_index, gain_index, bin_index, cap_size) {
    let module_id = Dwarfii_Api.ModuleId.MODULE_ASTRO;
    let interface_id = Dwarfii_Api.DwarfCMD.CMD_ASTRO_START_CAPTURE_WIDE_RAW_DARK_WITH_PARAM;
    let type_id = Dwarfii_Api.MessageTypeId.TYPE_REQUEST;
    // Obtain classname depending of the command
    // Obtain a message class
    const cmdClass = cmdMapping[interface_id];
...
export function messageAstroStopCaptureWideDarkFrameWithParam() {
    let module_id = Dwarfii_Api.ModuleId.MODULE_ASTRO;
    let interface_id = Dwarfii_Api.DwarfCMD.CMD_ASTRO_STOP_CAPTURE_WIDE_RAW_DARK_WITH_PARAM;
    let type_id = Dwarfii_Api.MessageTypeId.TYPE_REQUEST;
    // Obtain classname depending of the command
    // Obtain a message class
    const cmdClass = cmdMapping[interface_id];
 ...
 * @returns {Uint8Array}
 */
export function messageAstroDelWideDarkFrameList(exp_index, gain_index, bin_index) {
    let module_id = Dwarfii_Api.ModuleId.MODULE_ASTRO;
